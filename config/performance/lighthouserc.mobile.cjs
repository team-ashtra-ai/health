module.exports = {
  ci: {
    collect: {
      ...
      numberOfRuns: 5,
      settings: {
        // Lighthouse's mobile preset applies the throttled mobile CPU/network
        // profile and viewport used by PageSpeed Insights mobile.
        preset: 'mobile',
    ...
    upload: {
      target: 'filesystem',
      outputDir: 'performance-reports/lhci/mobile'
    }
  }
};
