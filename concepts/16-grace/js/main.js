(() => {
  ...
  const createWhatsApp = () => {
    ...
    link.appendChild(makeImage("../../assets/generated/concept-16/icons/sofiati-concept-16-whatsapp-cta-icon.svg", ""));
  ...
  const createBackToTop = () => {
    ...
    button.tabIndex = -1;
    button.appendChild(makeImage("../../assets/generated/concept-16/icons/sofiati-concept-16-back-to-top-icon.svg", ""));
    return button;
  };
