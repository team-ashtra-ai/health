(() => {
  ...
  const createWhatsApp = () => {
    ...
    link.appendChild(makeImage("../../assets/generated/concept-07/icons/sofiati-concept-07-whatsapp-cta-icon.svg", ""));
  ...
  const createBackToTop = () => {
    ...
    button.tabIndex = -1;
    button.appendChild(makeImage("../../assets/generated/concept-07/icons/sofiati-concept-07-back-to-top-icon.svg", ""));
    return button;
  };
