...
(() => {
  ...
  const CONFIG = {"code": "23", "slug": "ritual", "bg": "#F4EFE5", "fg": "#252321", "muted": "rgba(37,35,33,.64)", "accent": "#9A6B35", "border": "1px solid rgba(154,107,53,.20)", "width": "min(1220px,calc(100% - 40px))", "padding": "11px 0", "fontSize": ".78rem", "align": "left", "layout": "centered", "separator": "scan", "marker": "leaf", "buttonStyle": "soft", "radius": "8px", "autoDelayMs": 9000};
