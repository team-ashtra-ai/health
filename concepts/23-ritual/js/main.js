(() => {
  ...
  const createWhatsApp = () => {
    ...
    link.appendChild(makeImage("../../assets/generated/concept-23/icons/sofiati-concept-23-whatsapp-cta-icon.svg", ""));
  ...
  const createBackToTop = () => {
    ...
    button.tabIndex = -1;
    button.appendChild(makeImage("../../assets/generated/concept-23/icons/sofiati-concept-23-back-to-top-icon.svg", ""));
    return button;
  };
