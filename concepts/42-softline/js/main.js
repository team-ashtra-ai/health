(() => {
  ...
  const createWhatsApp = () => {
    ...
    link.appendChild(makeImage("../../assets/generated/concept-42/icons/sofiati-concept-42-whatsapp-cta-icon.svg", ""));
  ...
  const createBackToTop = () => {
    ...
    button.tabIndex = -1;
    button.appendChild(makeImage("../../assets/generated/concept-42/icons/sofiati-concept-42-back-to-top-icon.svg", ""));
    return button;
  };
