...
(() => {
  ...
  const CONFIG = {"code": "09", "slug": "radiance", "bg": "#FFFDF8", "fg": "#252321", "muted": "rgba(37,35,33,.62)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.18)", "width": "min(1220px,calc(100% - 40px))", "padding": "8px 0 9px", "fontSize": ".8rem", "align": "left", "layout": "ledger", "separator": "bottom-line", "marker": "bracket", "buttonStyle": "text", "radius": "999px", "autoDelayMs": 9600};
