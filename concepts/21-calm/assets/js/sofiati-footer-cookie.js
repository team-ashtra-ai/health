...
(() => {
  ...
  const CONFIG = {"code": "21", "slug": "calm", "bg": "#252321", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.24)", "width": "min(1220px,calc(100% - 40px))", "padding": "7px 0", "fontSize": ".81rem", "align": "left", "layout": "split", "separator": "none", "marker": "circle", "buttonStyle": "text", "radius": "4px", "autoDelayMs": 12800};
