(() => {
  ...
  const createWhatsApp = () => {
    ...
    link.appendChild(makeImage("../../assets/generated/concept-45/icons/sofiati-concept-45-whatsapp-cta-icon.svg", ""));
  ...
  const createBackToTop = () => {
    ...
    button.tabIndex = -1;
    button.appendChild(makeImage("../../assets/generated/concept-45/icons/sofiati-concept-45-back-to-top-icon.svg", ""));
    return button;
  };
