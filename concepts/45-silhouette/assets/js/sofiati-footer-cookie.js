...
(() => {
  ...
  const CONFIG = {"code": "45", "slug": "silhouette", "bg": "#FBFAF6", "fg": "#252321", "muted": "rgba(37,35,33,.64)", "accent": "#9A6B35", "border": "1px dashed rgba(154,107,53,.22)", "width": "min(1220px,calc(100% - 40px))", "padding": "11px 0 10px", "fontSize": ".77rem", "align": "center", "layout": "inline", "separator": "soft-top", "marker": "none", "buttonStyle": "square", "radius": "999px", "autoDelayMs": 8800};
