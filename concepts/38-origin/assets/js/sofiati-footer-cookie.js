...
(() => {
  ...
  const CONFIG = {"code": "38", "slug": "origin", "bg": "#202524", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#A2AEA0", "border": "1px solid rgba(162,174,160,.22)", "width": "min(1160px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".82rem", "align": "left", "layout": "minimal", "separator": "left-rule", "marker": "sprig", "buttonStyle": "soft", "radius": "999px", "autoDelayMs": 9100};
