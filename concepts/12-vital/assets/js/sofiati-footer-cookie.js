...
(() => {
  ...
  const CONFIG = {"code": "12", "slug": "vital", "bg": "#2E3A32", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#DAB26F", "border": "1px solid rgba(218,178,111,.22)", "width": "min(1160px,calc(100% - 34px))", "padding": "9px 0 10px", "fontSize": ".81rem", "align": "left", "layout": "split", "separator": "top-line", "marker": "dot", "buttonStyle": "pill", "radius": "2px", "autoDelayMs": 11700};
