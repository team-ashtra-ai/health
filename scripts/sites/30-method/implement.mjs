...
const siteProfile = {
  ...
  "slug": "method",
  "index": 29,
  "dnaName": "Method Process Ledger",
  "heroStrategy": "minimal promise block with tactile texture",
  "sectionRhythm": "quiet text-first sections with restrained media",
  "partialStrategy": "minimalHero, quietStatement, measuredCards, finalNote, footerMinimal",
  "mobileStrategy": "minimal pages remove decorative weight and keep final CTA visible",
