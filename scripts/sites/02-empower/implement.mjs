...
const siteProfile = {
  ...
  "slug": "empower",
  "index": 1,
  "dnaName": "Bronze Concierge Ledger",
  ...
  "partialStrategy": "conciergeHero, routeLedger, compactCta, supportStrip, footerIndex",
  "mobileStrategy": "routes collapse into touch-led ledger items with clear spacing",
