...
ROUTES = {
    ...
    "accessibility": ("accessibility.html", "acessibilidade.html", "/acessibilidade.html"),
...
SEO = {
    ...
    "accessibility": ("Acessibilidade | Franciele Sofiati", "Recursos e compromissos de acessibilidade do site Franciele Sofiati para uma navegação mais clara, inclusiva e funcional."),
    ...
    "legal": ("Informações legais | Franciele Sofiati", "Informações legais, termos de uso e orientações institucionais do site Franciele Sofiati."),
