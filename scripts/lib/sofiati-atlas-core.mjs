...
const IMAGE_FILES = {
  ...
  contact:
    "assets/images/contact/sofiati-contact-business-card-inspired-layout.webp",
  mission:
...
const PAGE_BLUEPRINTS = {
  home: [
    section(
      ...
      "A calm, attentive approach shaped around your goals, comfort, and realistic expectations.",
      {
        ...
        primaryHref: LINKS.consultation,
        secondary: "Message WhatsApp",
        secondaryHref: LINKS.whatsapp,
    ...
    section(
      ...
      {
        cards: ["Care", "Trust", "Safety", "Naturality"],
        primary: "View values",
        primaryHref: LINKS.values,
        secondary: "Read mission",
        secondaryHref: LINKS.mission,
    ...
    section(
      ...
      {
        primary: "Meet Franciele",
        primaryHref: LINKS.about,
        secondary: "Begin consultation",
        secondaryHref: LINKS.consultation,
    ...
    section(
      ...
      {
        cards: ["Care", "Skin", "Laser", "Results"],
        primary: "Explore care",
        primaryHref: LINKS.care,
        secondary: "View skin",
        secondaryHref: LINKS.skin,
    ...
    section(
      ...
      {
        bullets: ["Listen", "Assess", "Plan", "Guide"],
        primary: "Book consultation",
        primaryHref: LINKS.consultation,
        secondary: "Read FAQ",
        secondaryHref: LINKS.faq,
    ...
    section(
      ...
      {
        primary: "Understand results",
        primaryHref: LINKS.results,
        secondary: "Request evaluation",
        secondaryHref: LINKS.consultation,
    ...
    section(
      ...
      {
        cards: ["Skin guidance", "Laser questions", "Care planning"],
        primary: "Read journal",
        primaryHref: LINKS.journal,
        secondary: "View articles",
        secondaryHref: LINKS.blog,
    ...
    section(
      ...
      {
        primary: "Contact Franciele",
        primaryHref: LINKS.contact,
        secondary: "Open sitemap",
        secondaryHref: LINKS.sitemap,
  ...
  about: [
    ...
    section(
      ...
      {
        bullets: ["Listen carefully", "Explain clearly", "Plan responsibly"],
        primary: "View care",
        primaryHref: LINKS.care,
        asset: "Icon row",
      },
    ...
    section(
      ...
      {
        primary: "Read mission",
        primaryHref: LINKS.mission,
        secondary: "View values",
        secondaryHref: LINKS.values,
    ...
    section(
      ...
      {
        bullets: ["Ask", "Listen", "Assess", "Guide"],
        primary: "Book consultation",
        primaryHref: LINKS.consultation,
        secondary: "Read FAQ",
        secondaryHref: LINKS.faq,
  ...
  care: [
    ...
    section(
      ...
      {
        bullets: ["Goals", "Comfort", "Routine", "Expectations"],
        primary: "Begin consultation",
        primaryHref: LINKS.consultation,
    ...
    section(
      ...
      {
        bullets: ["Assess", "Plan", "Guide", "Review"],
        primary: "Request evaluation",
        primaryHref: LINKS.consultation,
        asset: "Process icons",
      },
    ...
    section(
      ...
      {
        primary: "View skin",
        primaryHref: LINKS.skin,
        secondary: "Explore laser",
        secondaryHref: LINKS.laser,
  ...
  laser: [
    ...
    section(
      ...
      {
        bullets: ["Assess", "Prepare", "Guide", "Review"],
        primary: "Book consultation",
        primaryHref: LINKS.consultation,
        asset: "Process icons",
      },
  ...
  skin: [
    ...
    section(
      ...
      {
        cards: ["Routine", "Texture", "Sensitivity", "Goals"],
        primary: "Begin consultation",
        primaryHref: LINKS.consultation,
        asset: "Context icons",
      },
    ...
    section(
      ...
      {
        cards: ["Texture", "Luminosity", "Comfort", "Routine"],
        primary: "View care",
        primaryHref: LINKS.care,
        asset: "Service icons",
      },
  ...
  results: [
    ...
    section(
      ...
      {
        bullets: ["Listen", "Assess", "Plan", "Review"],
        primary: "Book consultation",
        primaryHref: LINKS.consultation,
        asset: "Process icons",
      },
    ...
    section(
      ...
      {
        primary: "Feedback guidance",
        primaryHref: LINKS.testimonials,
        secondary: "Privacy",
        secondaryHref: LINKS.privacy,
        asset: "Privacy icon",
      },
  ...
  consultation: [
    ...
    section(
      ...
      {
        cards: ["Goals", "Questions", "Comfort", "Expectations"],
        primary: "Start form",
        primaryHref: LINKS.contact,
        asset: "Icons",
      },
    ...
    section(
      ...
      { primary: "Privacy", primaryHref: LINKS.privacy, asset: "Privacy icon" },
    ),
    section(
      "Related Guidance",
      "internal-route",
  ...
  contact: [
    ...
    section(
      ...
      {
        primary: "Privacy",
        primaryHref: LINKS.privacy,
        secondary: "Accessibility",
        secondaryHref: LINKS.accessibility,
        asset: "Trust icons",
      },
    ),
    section(
    ...
    section(
      ...
      "conversion-final",
      "Keep exploring",
      "Return home or open the sitemap for all routes.",
      {
        primary: "Home",
        primaryHref: LINKS.home,
        secondary: "Sitemap",
        secondaryHref: LINKS.sitemap,
        asset: "Footer detail",
      },
  ...
  mission: [
    ...
    section(
      ...
      "internal-route",
      "Learn more",
      "Explore the values behind the experience.",
      {
        primary: "About",
        primaryHref: LINKS.about,
        secondary: "Values",
  ...
  values: [
    ...
    section(
      ...
      { primary: "Explore care", primaryHref: LINKS.care, asset: "Care icon" },
    ),
    section(
      "Confianca",
      "trust-confidence",
      "Trust",
      "Trust grows through clear explanations and calm guidance.",
      {
        primary: "Meet Franciele",
        primaryHref: LINKS.about,
        asset: "Trust icon",
    ...
    section(
      ...
      "reassurance-safety",
      "Safety",
      "Safety means boundaries, evaluation, and realistic expectations.",
      { primary: "Read FAQ", primaryHref: LINKS.faq, asset: "Safety icon" },
    ),
    section(
      "Naturalidade",
      "trust-naturality",
  ...
  testimonials: [
    ...
    section(
      ...
      { primary: "Results", primaryHref: LINKS.results, asset: "Trust icon" },
    ),
    section(
      "Experience Themes",
      "trust-themes",
      ...
      {
        cards: ["Clarity", "Comfort", "Guidance", "Trust"],
        primary: "Read FAQ",
        primaryHref: LINKS.faq,
    ...
    section(
      ...
      "education-route",
      "Have questions",
      "Read common questions before contacting.",
      { primary: "FAQ", primaryHref: LINKS.faq, asset: "FAQ icon" },
    ),
    section(
      "Consultation CTA",
      "conversion-contact",
    ...
    section(
      ...
      "conversion-final",
      "Contact directly",
      "Send a message if you need guidance.",
      {
        primary: "Contact",
        primaryHref: LINKS.contact,
        secondary: "WhatsApp",
  ...
  faq: [
    ...
    section(
      ...
      {
        cards: ["What should I ask", "How do I prepare", "What happens next"],
        primary: "Begin consultation",
        primaryHref: LINKS.consultation,
        secondary: "Contact Franciele",
        secondaryHref: LINKS.contact,
    ...
    section(
      ...
      "Skin guidance should consider routine, sensitivity, and realistic goals.",
      {
        primary: "View skin",
        primaryHref: LINKS.skin,
        secondary: "Read journal",
        secondaryHref: LINKS.journal,
        asset: "Skin icon",
      },
    ),
    section(
      ...
      {
        primary: "Explore laser",
        primaryHref: LINKS.laser,
        secondary: "Begin consultation",
        secondaryHref: LINKS.consultation,
        asset: "Laser icon",
      },
  ...
  journal: [
    ...
    section(
      ...
      "education-route",
      "Latest notes",
      "Browse short educational pieces by topic.",
      {
        primary: "View blog",
        primaryHref: LINKS.blog,
        secondary: "Read FAQ",
  ...
  blog: [
    ...
    section(
      ...
      "education-route",
      "Latest articles",
      "Read short educational pieces by topic.",
      {
        primary: "Read more",
        primaryHref: LINKS.journal,
    ...
    section(
      ...
      "education-route",
      "Choose a path",
      "Follow the topic that matches your current question.",
      { primary: "View FAQ", primaryHref: LINKS.faq, asset: "Path icon" },
    ),
    section(
      "Education Break",
      "reassurance-statement",
    ...
    section(
      ...
      "education-faq",
      "Popular doubts",
      "Find practical answers before your next step.",
      { primary: "FAQ", primaryHref: LINKS.faq, asset: "FAQ icon" },
    ),
    section(
      "Related Services",
      "service-route",
      "Related pages",
      "Connect articles to service guidance.",
      {
        primary: "Care",
        primaryHref: LINKS.care,
        secondary: "Skin",
    ...
    section(
      ...
      "conversion-final",
      "Back to journal",
      "Return to the editorial guide library.",
      {
        primary: "Journal",
        primaryHref: LINKS.journal,
        secondary: "Contact",
  ...
  sitemap: [
    ...
    section(
      ...
      "reassurance-statement",
      "Clear routes",
      "A simple map helps every visitor move confidently.",
      { asset: "Route divider" },
    ),
    section(
      "Final CTA",
  ...
  404: [
    ...
    section(
      ...
      { primary: "Home", primaryHref: LINKS.home, asset: "Home icon" },
    ),
    section(
      "Consultation Path",
      "conversion-contact",
    ...
    section(
      ...
      { primary: "Sitemap", primaryHref: LINKS.sitemap, asset: "Sitemap icon" },
    ),
    section(
      "Final CTA",
      "conversion-final",
      "Continue calmly",
      "Choose a route and keep exploring.",
      {
        primary: "Home",
        primaryHref: LINKS.home,
        secondary: "Contact",
  ...
  "thank-you": [
    ...
    section(
      ...
      "service-route",
      "Explore care",
      "Learn more about care and skin guidance.",
      {
        primary: "Care",
        primaryHref: LINKS.care,
        secondary: "Skin",
    ...
    section(
      ...
      "education-route",
      "Read more",
      "Browse articles for practical education.",
      {
        primary: "Journal",
        primaryHref: LINKS.journal,
        secondary: "Blog",
...
function supportSections(topic, key, relatedHref) {
  return [
    ...
    section(
      ...
      { primary: "Contact", primaryHref: LINKS.contact, asset: "Choice icon" },
    ),
    section(
      "Related Route",
      "support-route",
      "Related page",
      "Continue to the most relevant support page.",
      {
        primary: "Related page",
        primaryHref: relatedHref,
        asset: "Route icon",
      },
    ),
    section(
    ...
    section(
      ...
      "conversion-contact",
      "Need help",
      "Send a message if something is unclear.",
      {
        primary: "Contact",
        primaryHref: LINKS.contact,
        secondary: "WhatsApp",
    ...
    section(
      ...
      "support-route",
      "More information",
      "Review related site guidance.",
      {
        primary: "Privacy",
        primaryHref: LINKS.privacy,
        secondary: "Legal",
        secondaryHref: LINKS.legal,
        asset: "Support icons",
      },
    ),
    section(
      ...
      "internal-route",
      "Find pages",
      "Use the sitemap to find any route.",
      {
        primary: "Sitemap",
        primaryHref: LINKS.sitemap,
        secondary: "Home",
        secondaryHref: LINKS.home,
        asset: "Sitemap icon",
      },
    ),
    section(
      ...
      "conversion-final",
      "Contact support",
      "Reach out if you need help using the site.",
      {
        primary: "Contact",
        primaryHref: LINKS.contact,
        secondary: "Home",
...
function sectionAsset(sectionItem, pageKey, profile, index) {
  ...
  if (
    sectionItem.role.includes("journal") ||
  ...
  if (
    sectionItem.role.includes("service") ||
    ["care", "skin", "laser", "results"].includes(pageKey)
  ) {
    const serviceKey =
      pageKey === "laser"
        ? "laser"
  ...
  if (
    sectionItem.role.includes("statement") ||
    sectionItem.role.includes("support") ||
  ...
  if (sectionItem.cards.length || sectionItem.bullets.length) {
    ...
    return {
      src,
      alt: `${sectionItem.name} icon for ${profile.siteName}`,
      kind: "icon",
    };
  }
  return {
...
function sectionHtml(sectionItem, pageKey, profile, index) {
  ...
  const actions = [
    ...
    actionHtml(sectionItem.secondary, sectionItem.secondaryHref, "soft"),
  ]
    .filter(Boolean)
    .join("\n          ");
...
function briefJson(profile) {
  ...
  return {
    ...
    pageFlow: pages.map((page) => ({
      page: page.key,
      sequence: page.sections.map((item) => item.name),
    })),
    ...
    seo: {
      ...
      canonicalBase: `https://www.sofiati.com/concepts/${profile.siteId}/`,
    },
    accessibility: {
    ...
    mobile: {
      strategy: profile.mobileStrategy,
      ctas: "Stacked, thumb-friendly, visible before final scroll",
    },
    qa: {
      sectionCount: 10,
      screenshotFocus:
        "premium spacing, distinct rhythm, no overlap, no generic filler",
    },
    cleanup: {
      obsoletePlanningFiles:
        "concept-level planning markdown is historical and removed from active folders",
      protectedAssets:
        "brand photos, local production assets, partials, and imported helpers",
    },
  ...
  return REQUIRED_PAGE_KEYS.map((key) => {
    ...
    const placements = sections
      ...
      .map((item) => ({
        sourcePage: key,
        section: item.displayNumber,
        anchorText: [item.primary, item.secondary]
        ...
        trustReason:
          "Places guidance near the visitor question being answered.",
        conversionReason:
          "Keeps consultation or contact routes near decision intent.",
      }));
...
function masterBrief(profile) {
  ...
  const pageSections = REQUIRED_PAGE_KEYS.map((key) => {
    const meta = PAGE_META[key];
    const rows = pageBlueprint(key, profile)
      .map(
        (item) =>
          `| ${item.displayNumber} | ${md(item.name)} | ${md(item.role)} | ${md(item.heading)} | ${md(item.paragraph)} | ${md(item.primary)} | ${md(item.secondary)} | ${md(item.layoutSignature)} |`,
      )
      .join("\n");
...
## 9. Page flow map
${REQUIRED_PAGE_KEYS.map(
  (key) =>
    `- ${PAGE_META[key].label}: ${pageBlueprint(key, profile)
      .map((item) => item.name)
      .join(" -> ")}`,
).join("\n")}
...
${internalLinks(profile)
  .map((entry) => {
    const placements = entry.placements
      .map(
        (item) =>
          `  - Section ${item.section}: ${item.anchorText} -> ${item.targets.join(", ")}. SEO: ${item.seoReason} Trust: ${item.trustReason} Conversion: ${item.conversionReason}`,
      )
      .join("\n");
...
export async function ensureSite(profileInput, options = {}) {
  ...
  if (!options.validateOnly) {
    if (await writeFileIfChanged(paths.brief, masterBrief(profile)))
      changed.push("MASTER-BRIEF.md");
    if (await writeFileIfChanged(paths.script, implementationScript(profile)))
      changed.push("implement.mjs");
    if (await writeFileIfChanged(paths.css, atlasCss(profile)))
      changed.push("css/atlas-story.css");
    for (const key of REQUIRED_PAGE_KEYS) {
      const meta = PAGE_META[key];
      const filePath = path.join(paths.conceptDir, meta.file);
      if (await writeFileIfChanged(filePath, pageHtml(key, profile)))
        changed.push(`concepts/${profile.siteId}/${meta.file}`);
    }
  }
  ...
  if (!options.validateOnly) {
    const report = implementationReport(
      ...
      changed,
      blockers,
      options.command || "direct",
    );
    if (await writeFileIfChanged(paths.report, report))
      changed.push("IMPLEMENTATION-REPORT.md");
    validation = validateSite(root, profile);
    const finalReport = implementationReport(
      profile,
      validation,
      changed,
      blockers,
  ...
  return {
    profile,
    changed,
    blockers: blockers.concat(validation.blockers),
    validation,
  };
}
...
export function validateSite(root, profileInput) {
  ...
  if (briefExists) {
    try {
      ...
      briefComplete = Boolean(
        json &&
        json.siteId === profile.siteId &&
        requiredPhrases.every((phrase) => brief.includes(phrase)),
      );
  ...
  for (const key of REQUIRED_PAGE_KEYS) {
    ...
    const attrsOk = sections.every((chunk) =>
      [
        "data-section=",
        "data-page=",
        "data-role=",
        ...
        "data-max-links=",
        "data-copy-density=",
      ].every((attr) => chunk.includes(attr)),
    );
    const copyOk = sections.every(
      (chunk) => /<h[12]\b/.test(chunk) && /<p\b/.test(chunk),
    );
    const linkCounts = sections.map(
      (chunk) =>
        (chunk.match(/<a\b/g) || []).length +
        (chunk.match(/<button\b/g) || []).length,
    );
    const overLimit = linkCounts.some((count) => count > 2);
    const hasRoute =
      /wa\.me|consultation\.html|contact\.html|data-form-route/.test(html);
    const hasReassurance =
      /data-role="[^"]*(reassurance|trust|safety|privacy|boundary|expectation)/.test(
        html,
      );
    const hasFinal = /data-role="conversion-final"/.test(html);
    const pageAssets = sections
      .map((chunk) => {
    ...
    if (sections.length !== 10)
      pagesWithoutTenSections.push(`${meta.file}: ${sections.length}`);
    if (comments.length !== 10)
      sectionsMissingComments.push(`${meta.file}: ${comments.length}`);
    if (!attrsOk) sectionsMissingDataAttributes.push(meta.file);
    if (!copyOk)
      blockers.push(
        `${meta.file}: section without actual heading or paragraph`,
      );
    ...
    pages.push({
      ...
      attrsOk,
      copyOk,
      maxLinks: Math.max(0, ...linkCounts),
      hasRoute,
      hasReassurance,
      hasFinal,
    });
...
${
  changed
    .filter((item) => item.startsWith("concepts/"))
    .map((item) => `- ${item}`)
...
function progressEntry(profileInput, validation = null) {
  ...
  return {
    ...
    tenSectionsPerPage: Boolean(
      v.pages?.length === REQUIRED_PAGE_KEYS.length &&
      !v.pagesWithoutTenSections?.length,
    ),
    sectionComments: Boolean(
      v.pages?.length === REQUIRED_PAGE_KEYS.length &&
      !v.sectionsMissingComments?.length,
    ),
    sectionAttributes: Boolean(
      v.pages?.length === REQUIRED_PAGE_KEYS.length &&
      !v.sectionsMissingDataAttributes?.length,
    ),
    actualCopy: Boolean(v.pages?.every((page) => page.copyOk)),
    internalLinks: Boolean(
      v.pages?.length === REQUIRED_PAGE_KEYS.length &&
      !v.sectionsOverLinkLimit?.length &&
      !v.pagesMissingFormOrWhatsapp?.length,
    ),
    assetsMapped: Boolean(v.assetsMapped && !v.missingAssets?.length),
    partialsMapped: Boolean(v.partialsMapped),
    seoChecked: Boolean(
      v.briefComplete && v.pages?.length === REQUIRED_PAGE_KEYS.length,
    ),
    ...
    status: complete
      ? "complete"
      : v.briefExists || v.scriptExists || v.pages?.length
        ? "in-progress"
        : "not-started",
...
export async function writeProgress(root, atlas, validations = new Map()) {
  const entries = atlas.map((site) => {
    const validation =
      validations.get(site.siteId) || validateSite(root, siteProfile(site));
    return progressEntry(site, validation);
  });
  const payload = {
    generatedAt: nowStamp(),
    totalSites: entries.length,
    completeSites: entries.filter((entry) => entry.status === "complete")
      .length,
    sites: entries,
  };
  await writeFileIfChanged(
    path.join(root, "docs", "sites", "ATLAS-PROGRESS.json"),
...
export async function writeIndex(root, atlas) {
  const rows = atlas
    .map(
      (site) =>
        `| ${site.siteId} | ${site.siteName} | [MASTER-BRIEF.md](${site.siteId}/MASTER-BRIEF.md) | ../../scripts/sites/${site.siteId}/implement.mjs | [IMPLEMENTATION-REPORT.md](${site.siteId}/IMPLEMENTATION-REPORT.md) |`,
    )
    .join("\n");
...
`;
  await writeFileIfChanged(
    path.join(root, "docs", "sites", "INDEX.md"),
    content,
  );
}
...
`;
  await writeFileIfChanged(
    path.join(root, "docs", "sites", "ATLAS-CONTINUATION-REPORT.md"),
    content,
  );
}
...
export async function bootstrapAtlas(root, atlas) {
  ...
  if (!existsSync(path.join(root, "docs", "sites", "ATLAS-PROGRESS.json"))) {
    const entries = atlas.map((site) =>
      progressEntry(site, validateSite(root, siteProfile(site))),
    );
    const payload = {
      generatedAt: nowStamp(),
      totalSites: entries.length,
  ...
  if (
    ...
    await writeFileIfChanged(
      path.join(root, "docs", "sites", "ATLAS-CONTINUATION-REPORT.md"),
      `# Sofiati Atlas Continuation Report
...
export async function runAtlas(root, atlasInput, options = {}) {
  ...
  const completeBefore =
    progressBefore?.sites?.filter((site) => site.status === "complete")
      .length || 0;
  ...
  for (const site of selected) {
    const result = await ensureSite(site, {
      root,
    ...
    aggregate.sectionsOverLinkLimit.push(
      ...result.validation.sectionsOverLinkLimit.map(
        (item) => `${site.siteId}/${item}`,
      ),
    );
    aggregate.pagesMissingFormOrWhatsapp.push(
      ...result.validation.pagesMissingFormOrWhatsapp.map(
        (item) => `${site.siteId}/${item}`,
      ),
    );
    aggregate.pagesMissingReassurance.push(
      ...result.validation.pagesMissingReassurance.map(
        (item) => `${site.siteId}/${item}`,
      ),
    );
    aggregate.pagesMissingFinalCta.push(
      ...result.validation.pagesMissingFinalCta.map(
        (item) => `${site.siteId}/${item}`,
      ),
    );
    aggregate.missingAssets.push(
      ...result.validation.missingAssets.map(
        (item) => `${site.siteId}/${item}`,
      ),
    );
    await writeProgress(root, atlas, validations);
    await writeContinuationReport(root, atlas, {
      command: options.command,
      completeBefore,
      completedDuring,
      ...aggregate,
  ...
  for (const site of atlas) {
    if (!validations.has(site.siteId))
      validations.set(site.siteId, validateSite(root, siteProfile(site)));
  }
...
function selectSites(root, atlas, options) {
  ...
  const incomplete = atlas.filter(
    (site) => !validateSite(root, siteProfile(site)).complete,
  );
  if (options.all || options.validateOnly || options.cleanup)
    return options.validateOnly ? atlas : incomplete;
...
export function atlasStatus(root, atlasInput) {
  const atlas = normalizeAtlas(atlasInput);
  const progress = loadProgress(root);
  const validations = atlas.map((site) => ({
    site,
    validation: validateSite(root, siteProfile(site)),
  }));
  const complete = validations.filter(
    (item) => item.validation.complete,
  ).length;
  const progressComplete = progress?.completeSites ?? 0;
  const next =
    validations.find((item) => !item.validation.complete)?.site.siteId ||
    "none";
  return {
    complete,
    total: atlas.length,
...
export async function cleanupAtlas(root, atlasInput) {
  const atlas = normalizeAtlas(atlasInput);
  const removed = [];
  const conceptPlanningNames = new Set([
    "design-dna.md",
    "design-notes.md",
    "page-flow-map.md",
  ...
  for (const site of atlas) {
    for (const name of conceptPlanningNames) {
      ...
      if (await removeIfExists(filePath))
  ...
  if (await removeIfExists(path.join(root, "scripts", "__pycache__")))
    removed.push("scripts/__pycache__");
  return removed;
}
